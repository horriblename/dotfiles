...
-- openBold and closeBold form a state machine to check whether the cursor is within
-- a bold block
...
_G.ToggleItalic = function() toggleEmphasis('italic') end
...
function TestOpenBold()
   ...
   for i, t in ipairs(tests) do
      -- print(t.line)
      -- print(string.rep(' ', t.limit - 2), '^')
      local res = leftEmphasis(t.line, 1, t.limit, t.type)
      if res ~= t.ans then
